...
export class TreoVerticalNavigationComponent
  ...
  @ViewChild('navigationContent', { static: false })
  ...
  set appearance(value: TreoVerticalNavigationAppearance) {
    ...
    appearanceClassName =
      'treo-vertical-navigation-appearance-' + this.appearance;
  ...
  set treoScrollbarDirectives(
    treoScrollbarDirectives: QueryList<TreoScrollbarDirective>
  ) {
    ...
    this._treoScrollbarDirectivesSubscription = merge(
    ...
    setTimeout(() => {
      ...
      // Otherwise
        ...
        this._treoScrollbarDirectives.forEach(treoScrollbarDirective => {
          ...
          treoScrollbarDirective.scrollToElement(
            '.treo-vertical-navigation-item-active',
            -120,
            true
          );
  ...
  private _showOverlay(): void {
    ...
    if (this.transparentOverlay) {
      this._overlay.classList.add(
        'treo-vertical-navigation-overlay-transparent'
      );
    }
