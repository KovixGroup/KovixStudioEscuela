...
export class CourseListComponent
  ...
  public listDataSource: MatTableDataSource<
    Course | EntityFormGroup<Course>
  >;

  public listTableColumns: string[];

  public addingEntity: BehaviorSubject<Course | null> = new BehaviorSubject(
    null
  );
  ...
  public addToCart(entity: Course): void {
